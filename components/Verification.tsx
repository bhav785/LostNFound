                    ...
                    {progress < 4 ? (
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center text-center">
                                ...
                                <p className="font-hand text-gray-500 text-sm mb-6">Because trust should be earned.</p>
                                ...
                                <p className="text-xs font-mono uppercase tracking-widest text-[#2d2d2d]">Scan at Depot 04</p>
                            </div>
                        </motion.div>
                    )}
               </AnimatePresence>
